...
* **Serialização Binária:** Sistema de persistência de dados (Save/Load) implementado nativamente com `fwrite/fread` para manipulação direta de arquivos.
...
- [x] **Persistência de Dados:** Sistema básico de salvamento e carregamento (I/O Binário).
